...
export declare type StringField = (
...
export declare type BooleanField = (
...
export declare type DateTimeField = (
...
export declare type RichTextField<WithNamespace extends boolean = false> = (
...
export declare type RichTextTemplate<WithNamespace extends boolean = false> =
...
export declare type ObjectField<WithNamespace extends boolean = false> = (
...
declare type Field<WithNamespace extends boolean = false> = (
  | StringField
  | NumberField
  | BooleanField
  | DateTimeField
  ...
  MaybeNamespace<WithNamespace>;
export declare type TinaField<WithNamespace extends boolean = false> =
  Field<WithNamespace> & MaybeNamespace<WithNamespace>;
declare type MaybeNamespace<WithNamespace extends boolean = false> =
...
export declare type TinaCMSConfig<
  CMSCallback = undefined,
  FormifyCallback = undefined,
  DocumentCreatorCallback = undefined,
  Store = undefined
...
export declare type Collection<WithNamespace extends boolean = false> =
...
export declare type TemplateCollection<WithNamespace extends boolean = false> =
  {
    /**
    ...
    MaybeNamespace<WithNamespace>;
export declare type FieldCollection<WithNamespace extends boolean = false> = {
  /**
...
export declare type Collectable = Pick<
  Collection<true>,
...
export declare type TinaCloudSchema<WithNamespace extends boolean = false> =
...
export declare type TinaCloudCollection<WithNamespace extends boolean = false> =
...
export declare type ObjectType<WithNamespace extends boolean = false> =
  ObjectField<WithNamespace>;
/** @deprecated use RichTextField instead */
export declare type RichTextType<WithNamespace extends boolean = false> =
  RichTextField<WithNamespace>;
/** @deprecated use ReferenceField instead */
export declare type ReferenceType<WithNamespace extends boolean = false> =
...
/** @deprecated use TinaField instead */
export declare type SchemaField<WithNamespace extends boolean = false> =
