...
components:
  - title: Відділ з питань ветеранської політики
    ...
    employment:
      ...
      item:
        - desc: >-
            Відділ ветеранської політики працює над тим, щоб допомогти ветеранам
            та ветеранам повернутись до мирного життя після служби. Основна мета
            – підтримка, адаптація та створення можливостей для розвитку.
          descEng: >-
  ...
  - title: 'Основні функції відділу:'
    function:
      - name: Розробка та впровадження програм підтримки
      - name: Співпраця з іншими установами
