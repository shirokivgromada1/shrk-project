...
components:
  - title: Регуляторні акти
    ...
    notMain: false
    order:
      - title: 'Про встановлення ставок та пільг із сплати податку на нерухоме майно, відмінне від земельної ділянки у Широківській сільській раді Запорізького району Запорізької області'
        link: '/uploads/Рішення від 30.06.2021 №1 Про встановлення ставок та пільг із сплати податку на нерухоме майно, відмінне від земельної ділянки у Широківській сільській раді Запорізького району Запорізької області.pdf'
  ...
  - title: ''
    document:
      ...
      - title: Проєкти регуляторних актів
        link: 'https://shtg.gov.ua/Drafts-of-Regulatory-Acts'
    _template: Documents
---
