...
components:
  - title: звіти депутатів широківської сільської ради
    subtitle: Сторінка перебуває на доопрацюванні. Уся необхідна інформація поступово переноситься зі старої версії сайту. Просимо вибачення за тимчасові незручності.
    notMain: false
    order:
